...
class _ProductDetailScreenState extends ConsumerState<ProductDetailScreen> {
  ...
  Widget _buildContent(
    ...
    final isInCart =
        ref.watch(cartProvider.select((c) => c.hasProduct(product.id)));
    final cartItem =
        ref.watch(cartProvider.select((c) => c.getItem(product.id)));
  ...
  Widget _buildImageSliver(ProductEntity product, bool isDark) => SliverAppBar(
        expandedHeight: 380,
        pinned: true,
            ...
            child: product.imageUrls.isEmpty
                ? Container(
                    ...
                    child: const Icon(Icons.image_outlined,
                        color: HAColors.slate400, size: 64),
                  )
                : PageView.builder(
                    ...
                    itemBuilder: (_, i) => Hero(
                      ...
                      child: CachedNetworkImage(
                        ...
                        placeholder: (_, __) => Container(
                            color: isDark
                                ? HAColors.darkElevated
                                : HAColors.lightElevated),
                      ),
                    ),
                  ),
          ),
  ...
  Widget _buildCategoryBadge(ProductEntity product, bool isDark) => Container(
        ...
        decoration: BoxDecoration(
          color: HAColors.secondary.withValues(alpha: 0.12),
        ...
        children: [
          ...
          if (product.isInStock)
            Container(
              ...
              decoration: BoxDecoration(
                color: HAColors.success.withValues(alpha: 0.12),
                borderRadius: BorderRadius.circular(6),
              ),
              child: Text('In Stock',
                  style: HATextStyles.labelSmall
                      .copyWith(color: HAColors.success)),
            )
          else
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
              decoration: BoxDecoration(
                color: HAColors.error.withValues(alpha: 0.12),
                borderRadius: BorderRadius.circular(6),
              ),
              ...
              return Column(
                children: [
                  ...
                  if (!isLast)
                    Divider(
                      color:
                          isDark ? HAColors.darkDivider : HAColors.lightDivider,
                      height: 1,
                      indent: 16,
                      endIndent: 16,
                    ),
            ...
            Expanded(
              child: SizedBox(
                ...
                child: DecoratedBox(
                  decoration: BoxDecoration(
                    gradient:
                        product.isInStock ? HAColors.primaryGradient : null,
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      ...
                      style:
                          HATextStyles.labelLarge.copyWith(color: Colors.white),
                    ),
                  ),
                ),
              ),
